                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" src="images/profile/sanjida.jpg" alt="Avatar" title="Change the avatar">
                        </div>
                      </div>
                      <h3>Sanjida Tasnim</h3>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td class="vertical-align-mid">
                                    <div class="progress">
                                      <div class="progress-bar progress-bar-success" data-transitiongoal="40"></div>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                  <td>2</td>
                                  <td>Encription & Decription</td>
                                  <!-- <td>Deveint Inc</td> -->
                                  <td class="hidden-phone">60</td>
                                  <td class="vertical-align-mid">
                                    <div class="progress">
                                      <div class="progress-bar progress-bar-danger" data-transitiongoal="50"></div>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                            <table style="width:100%">
                              ...
                              <tr>
                                ...
                                <td><h5> Facination in make up, Shopping, Traveling</h5></td>
                              </tr>
                              <!-- <tr>
                            ...
                            <a href="sanjidatasnim843@gmail.com ">
