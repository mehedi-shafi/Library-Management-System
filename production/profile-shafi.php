                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" src="images/profile/shafi.jpg" alt="Avatar" title="Change the avatar">
                        </div>
                      </div>
                      <h3>Mehedi Imam Shafi</h3>
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                            ...
                            <a href="https://www.linkedin.com/in/mehedi-shafi-40924251/">
                              <img src="images/profile/in.png" alt="Github" style="width:30px;height:30px;border:0">
                            </a>
                          </div>
                        </div>
                      </div>
