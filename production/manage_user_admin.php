<?php
    ...
    $query = "SELECT * FROM user_details, login WHERE login.user_id = user_details.user_id AND login.type = 'user' ORDER BY login.user_id ASC";
    $temp = mysqli_query($con, $query);
    if (!$temp){
        die("Query returned nothing while trying to fetch data for user details");
    }
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                          <?php while ($user= mysqli_fetch_assoc($temp)){ ?>
                        <tr>
                          ...
                          <td><a href="remove_user.php?uid=<?php echo $user["user_id"]; ?>" class="btn btn-primary btn-xs"> Remove </a></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
