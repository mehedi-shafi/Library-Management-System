            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    <br />
                    <form enctype="multipart/form-data" name="update_user_user" action="update_user_user.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">First Name
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" class="form-control col-md-7 col-xs-12" name="first_name" placeholder="<?php echo $return_row_details["first_name"]; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" class="form-control col-md-7 col-xs-12" name="last_name" placeholder="<?php echo $return_row_details["last_name"]; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label name="email" class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Email
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="last-name" name="email"  class="form-control col-md-7 col-xs-12" placeholder="example@domain.com">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="quote">Update Profile Quote
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="quote" id="quote" placeholder="<?php echo $return_row_details["fav_quote"]; ?>" class="date-picker form-control col-md-7 col-xs-12" type="text">
                        </div>
                      </div>
                      <div class="form-group">
