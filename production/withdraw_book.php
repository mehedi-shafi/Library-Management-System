        ...
        <div class="right_col" role="main">
          <div class="">
                    ...
                    <?php
                        if (isset($_GET["gave"])){
                            if ($_GET["gave"] == "success"){
                                echo "<h3> Thank you for returning </h3>";
                            }
                        }
                    ?>
                    <form method="post" action="user_search.php" id="user_form">
                        <input type="hidden" name="url" value="<?php echo $actual_link; ?>" />
                        <input class="form-control col-md-7 col-xs-12" style="width: 200px; height: 30px;"type="text" placeholder="Search for user" name="username">
                        <input type="submit" name="sub_user" value="GO">
                    </form>
                    <br />
                    <form action="return_book.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="book_id"> Book ID<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="book_id" required="required" id="book_id" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="amount"> Fine </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="amount" id="amount" class="form-control col-md-7 col-xs-12" placeholder="If any">
                        </div>
                      </div>
            ...
            <div class="row" style="margin-left: 50px;">
                <iframe src="withdrawal.php?uid=<?php echo $user_id; ?>" width="400" height="400"></iframe>
            </div>
          </div>
        </div>
        <!-- /page content -->
